...
FakeSynth::FakeSynth (unsigned int midiChannel) :
	m_Amplitude( 0.2f ),
	m_Osc(),
...
void FakeSynth::setOscillatorMode (const OscillatorMode& oscMode)
{
	m_Osc.setOscillatorMode( oscMode );
}
...
{
	if ( keyEvent.getChannel() == m_MidiChannel )
	{
